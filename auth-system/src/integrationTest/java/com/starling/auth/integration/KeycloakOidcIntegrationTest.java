package com.starling.auth.integration;

import com.starling.auth.repository.IdentityRepository;
import com.starling.auth.repository.RoleRepository;
...
class KeycloakOidcIntegrationTest {
    ...
    static final PostgreSQLContainer postgres = new PostgreSQLContainer("postgres:16-alpine")
            .withDatabaseName("starling_auth")
            .withUsername("starling_service")
    ...
    static final GenericContainer<?> keycloak = new GenericContainer<>("quay.io/keycloak/keycloak:latest")
            ...
            .waitingFor(Wait.forHttp("/realms/starling/.well-known/openid-configuration")
                    .forPort(8080)
                    .forStatusCode(200));
    ...
    static void dynamicProperties(DynamicPropertyRegistry registry) {
        ...
        String issuer = "http://" + keycloak.getHost() + ":" + keycloak.getMappedPort(8080) + "/realms/starling";
        registry.add("spring.security.oauth2.client.provider.okta.issuer-uri", () -> issuer);
        registry.add("starling.oidc.provider-id", () -> issuer);

        registry.add("spring.security.oauth2.client.registration.okta.client-id", () -> "starling-client");
        registry.add("spring.security.oauth2.client.registration.okta.client-secret", () -> "starling-secret");
    ...
    void oauth2AuthorizationEndpoint_redirectsToKeycloak_andDbIsMigratedAndSeeded() throws Exception {
        ...
        String expectedAuthBase = "http://" + keycloak.getHost() + ":" + keycloak.getMappedPort(8080)
                + "/realms/starling/protocol/openid-connect/auth";
