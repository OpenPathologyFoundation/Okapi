...
@Entity
@Table(schema = "iam", name = "break_glass_grant")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class BreakGlassGrantEntity {
    ...
    @Column(name = "scope_entity_type", nullable = false)
    private String scopeEntityType;

    @Column(name = "scope_entity_id", nullable = false)
