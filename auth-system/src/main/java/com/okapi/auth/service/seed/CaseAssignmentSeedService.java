...
import com.okapi.auth.service.seed.SeedCaseAssignmentModels.*;
...
public class CaseAssignmentSeedService {
    ...
    public CaseAssignmentSeedService(
            ...
            @Value("${okapi.seed.case-assignments.path:../seed/wsi/case-assignments.v1.json}") String seedFilePath) {
