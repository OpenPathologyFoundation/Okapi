...
public class CaseSeedService {
    ...
    private boolean upsertCase(Map<String, Object> seedCase) {
        ...
        // Upsert case — look up patient by MRN pattern derived from caseId
        // The SQL seed script maps specific cases to specific patient MRNs.
        // We replicate that mapping here.
        String patientMrn = getPatientMrnForCase(caseId);
    ...
    private void seedSlides(UUID caseUuid, String caseId, List<Map<String, Object>> slides) {
        ...
        for (Map<String, Object> slide : slides) {
            ...
            if (suffix.startsWith("_")) {
                ...
                // Format: -01-01-01 (PS26-00001 style)
    ...
    /**
     * Maps case IDs to patient MRNs (matching the SQL seed script).
     */
    private String getPatientMrnForCase(String caseId) {
        return switch (caseId) {
            case "PS26-00001" -> "XN-000003";
            case "S26-0001" -> "XN-000024";
            case "S26-0002" -> "XN-000030";
            case "S26-0003" -> "XN-000037";
            case "S26-0004" -> "XN-000018";
            case "S26-0005" -> "XN-000001";
            default -> null;
        };
    }
