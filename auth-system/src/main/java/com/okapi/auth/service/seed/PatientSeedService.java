...
import com.okapi.auth.model.db.PatientEntity;
import com.okapi.auth.repository.AuditEventRepository;
import com.okapi.auth.repository.PatientRepository;
import com.okapi.auth.service.seed.SeedPatientModels.SeedPatientsFile;
import com.okapi.auth.service.seed.SeedPatientModels.SeedPatient;
...
public class PatientSeedService {
    ...
    public PatientSeedService(
            ...
            @Value("${okapi.seed.patients.path:../seed/patients/xenonym-azure-vale-9728.json}") String seedFilePath
    ) {
