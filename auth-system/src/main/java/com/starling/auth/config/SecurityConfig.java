...
import com.starling.auth.service.AuthAuditService;
import com.starling.auth.service.CustomOidcUserService;
...
public class SecurityConfig {
    ...
    @Value("${starling.viewer.allowed-origins:}")
    private String viewerAllowedOrigins;

    @Value("${starling.oidc.end-session-uri}")
     ...
     * or deployments where the viewer is on a subdomain (e.g., viewer.starling.local).
     *
     * Configure via: STARLING_VIEWER_ALLOWED_ORIGINS=http://viewer.starling.local,http://localhost:5174
     */
    @Bean
    ...
    public LogoutSuccessHandler logoutSuccessHandler() {
        return (HttpServletRequest request, HttpServletResponse response, Authentication authentication) -> {
            ...
            String logoutUrl = UriComponentsBuilder
                    ...
                    .queryParam("client_id", "starling-client")
     ...
     * expects (e.g. https://starling.openpathology.tech).
     */
