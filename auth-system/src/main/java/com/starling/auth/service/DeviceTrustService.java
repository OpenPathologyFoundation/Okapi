...
import com.starling.auth.model.db.SessionDeviceEntity;
import com.starling.auth.repository.IdentityRepository;
import com.starling.auth.repository.SessionDeviceRepository;
...
public class DeviceTrustService {
    ...
    public DeviceTrustService(
            ...
            @Value("${starling.device.trust.ttl-days:30}") long trustTtlDays) {
